...
| Name | Links | Description | Quasar |
| --- | --- | --- | --- |
| Quasar Admin Template | [github](https://github.com/jinjingmail/quasar-admin-template), [website](http://jinjinge.gitee.io/quasar-admin-template/) | Free Quasar Admin Template based on Vue js and Quasar Framework. | v1.15.0 |
